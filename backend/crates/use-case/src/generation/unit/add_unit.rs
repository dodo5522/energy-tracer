...
impl<Tx, U: UnitOfWorkTrait<Tx>, F: UnitOfWorkFactoryTrait<Tx, U>, R: UnitRepositoryTrait<Tx>>
    ErrorMapperTrait for AddUnitUseCase<Tx, R, U, F>
{
}

impl<Tx, U: UnitOfWorkTrait<Tx>, F: UnitOfWorkFactoryTrait<Tx, U>, R: UnitRepositoryTrait<Tx>>
    AddUnitUseCase<Tx, R, U, F>
{
    ...
    pub async fn add(self, input: UnitEntity) -> Result<(), GenerationError> {
